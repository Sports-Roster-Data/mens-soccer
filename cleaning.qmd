...
rosters25 <- read_csv("rosters_2025_I.csv")
rosters_msoc <- read_csv("rosters_msoc_2025.csv") |> mutate(ncaa_id = as.numeric(ncaa_id))
...
write_csv(need_rosters, "need_rosters.csv")
